...
urlpatterns = [
    ...
    path("abteilungen/", views.abteilung_liste, name="abteilung_liste"),
    path("abteilungen/neu/", views.abteilung_neu, name="abteilung_neu"),
    path(
        "abteilungen/<int:pk>/bearbeiten/",
        views.abteilung_bearbeiten,
        name="abteilung_bearbeiten",
    ),
    path("abteilungen/<int:pk>/loeschen/", views.abteilung_loeschen, name="abteilung_loeschen"),
